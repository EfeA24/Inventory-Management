REPORT ZINVENTORY_MANAGEMENT_MODULE.

TABLES: MARA,MARC,MBEW,MVKE.
...
DATA: it_materials TYPE TABLE OF wa_material,
      wa_transaction TYPE ty_transaction,
      it_transactions TYPE TABLE OF ty_transaction,
      gt_alv TYPE TABLE OF lvc_s_fcat,
      gs_alv TYPE lvc_s_fcat,
...
* Subroutine to display inventory report
